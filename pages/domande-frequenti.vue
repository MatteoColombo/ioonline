      ...
      <v-expansion-panels>
        ...
        >
          ...
          <v-expansion-panel-content>
            <p v-for="answer in item.answer" :key="answer" v-html="answer"></p>
            <ul>
              <li v-for="step in item.steps" :key="step" v-html="step"></li>
            </ul>
          </v-expansion-panel-content>
        </v-expansion-panel>
      </v-expansion-panels>

      <h3 class="text-center">{{ $t("faq.questions") }}</h3>
      <div class="contacts">
        <v-row>
